...
var y_til pi i_hat y_hat rn_hat nu z a sigma_a;
// Declare exogenous variables
varexo e_nu e_z e_a e_siga;
// Declare parameters
parameters beta sigma psi epsilon_p zeta delta tri rho_nu rho_z rho_a phi_pi phi_y tau lambda Mu_p omega kappa Psi Del_p_pi gamma Phi psi_a sd_e_nu sd_e_z sd_e_a rho_siga sigma_siga sd_e_siga;
//prefs/technology
beta=0.9745;
sigma = 1;
psi = 1;
