...
varexo e_nu e_z e_a;
// Declare parameters
parameters beta sigma psi epsilon_p zeta delta tri rho_nu rho_z rho_a phi_pi phi_y tau lambda Mu_p omega kappa Psi Del_p_pi gamma Phi psi_a;
//prefs/technology
beta=0.9745;
sigma = 1;
psi = 1;
...
//simulate for 100 quarters
stoch_simul(periods = 200, drop = 100, tex);

// y_til is first endo var
//oo_.endo_simul 